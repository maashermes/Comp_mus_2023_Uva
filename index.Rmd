...
If we try to cluster the songs using an average linking clustering method, we see that the clusters it finds are not necessarily clusters separating the two songs. We clustered on the following features: danceability, energy, loudness, acousticness, instrumentalness, liveness, valence and tempo. 
